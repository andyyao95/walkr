...
\code{hit-and-run} package on CRAN (\cide{hitandrun}). \code{walkr} serves as a convenient wrapper
...
<<eval = FALSE>>=
vis_sampling(x = answer, chains = 5)
@
...
<<eval = TRUE, fig.width=5, fig.height=3>>=
set.seed(314)
N <- 50

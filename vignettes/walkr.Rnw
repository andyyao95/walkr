...
Now, \code{sampled\_points} contain 1000 points from the $3$D simplex. We can visualize the MCMC random walks 
by calling the \code{explore\_walkr} function, which launches a \code{shiny} interface from \pkg{shinystan}.

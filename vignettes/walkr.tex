...
\hlstd{A} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{),} \hlkwc{ncol} \hlstd{=} \hlnum{3}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in matrix(c(1, 0, 1, 0, 1), ncol = 3): data length [5] is not a sub-multiple or multiple of the number of rows [2]}}\begin{alltt}
...
\begin{verbatim}
##            [,1]      [,2]      [,3]      [,4]      [,5]      [,6]
## [1,] 0.64213739 0.5005789 0.5294071 0.2455340 0.2610428 0.1525811
## [2,] 0.07112819 0.2029761 0.1251093 0.1508854 0.4145434 0.4532236
## [3,] 0.28673442 0.2964451 0.3454836 0.6035806 0.3244138 0.3941953
##           [,7]      [,8]      [,9]      [,10]
## [1,] 0.3720534 0.4038622 0.4001039 0.52319260
## [2,] 0.4833888 0.4587185 0.3254509 0.38458222
## [3,] 0.1445578 0.1374193 0.2744452 0.09222518
\end{verbatim}
\end{kframe}
\end{knitrout}
...
As we can in the two trace-plots below, the 

...
\hlstd{answer} \hlkwb{<-} \hlkwd{walkr}\hlstd{(}\hlkwc{A} \hlstd{= A,} \hlkwc{b} \hlstd{= b,} \hlkwc{points} \hlstd{=} \hlnum{10}\hlstd{,} \hlkwc{method} \hlstd{=} \hlstr{"hit-and-run"}\hlstd{,}
                \hlkwc{thin} \hlstd{=} \hlnum{1}\hlstd{,} \hlkwc{burn} \hlstd{=} \hlnum{0}\hlstd{,} \hlkwc{chains} \hlstd{=} \hlnum{5}\hlstd{,} \hlkwc{ret.format} \hlstd{=} \hlstr{"list"}\hlstd{)}
\end{alltt}
...
## [[1]]
##             [,1]      [,2]
## [1,] 0.748182847 0.5688588
## [2,] 0.247690936 0.3272884
## [3,] 0.004126217 0.1038527
## 
## [[2]]
##           [,1]      [,2]
## [1,] 0.4598451 0.4034480
## [2,] 0.0905776 0.4380749
## [3,] 0.4495773 0.1584771
## 
## [[3]]
##             [,1]       [,2]
## [1,] 0.853371532 0.53165438
## [2,] 0.137500693 0.41407309
## [3,] 0.009127776 0.05427253
## 
## [[4]]
##           [,1]       [,2]
## [1,] 0.1421933 0.04891122
## [2,] 0.7174856 0.88293460
## [3,] 0.1403211 0.06815417
## 
## [[5]]
##            [,1]      [,2]
## [1,] 0.49714858 0.7059685
## [2,] 0.41861099 0.1829643
## [3,] 0.08424042 0.1110672
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{explore_walkr}\hlstd{(answer)}
\end{alltt}
\end{kframe}
\end{knitrout}

...
\hlkwd{plot}\hlstd{(}\hlopt{-}\hlkwd{log}\hlstd{(z)}\hlopt{~}\hlstd{z,} \hlkwc{type} \hlstd{=} \hlstr{'l'}\hlstd{,} \hlkwc{ylim} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{10}\hlstd{))}
\end{alltt}
\end{kframe}
...
\hlkwd{plot}\hlstd{((}\hlnum{1}\hlopt{/}\hlstd{z}\hlopt{^}\hlnum{2}\hlstd{)}\hlopt{~}\hlstd{z,} \hlkwc{type} \hlstd{=} \hlstr{'l'}\hlstd{,} \hlkwc{ylim} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{100}\hlstd{))}
\end{alltt}
\end{kframe}
...
\begin{verbatim}
##           [,1]      [,2]      [,3]      [,4]      [,5]      [,6]      [,7]
## [1,] 0.3310648 0.1005510 0.4174974 0.4299083 0.1091779 0.2569246 0.7384966
## [2,] 0.4791352 0.2931248 0.4348637 0.2582013 0.3606443 0.3452742 0.2425498
## [3,] 0.1898000 0.6063242 0.1476389 0.3118904 0.5301779 0.3978013 0.0189536
##            [,8]      [,9]     [,10]
## [1,] 0.72833256 0.3553689 0.3240811
## [2,] 0.26210362 0.4366531 0.3780780
## [3,] 0.00956382 0.2079781 0.2978409
\end{verbatim}
\end{kframe}
\end{knitrout}
